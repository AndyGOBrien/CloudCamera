...
// userImages, such as face, landmark, logo, label, and text detection. The
// ImageAnnotator service returns detected entities from the userImages.
service ImageAnnotator {
  // Run image detection and annotation for a batch of userImages.
  rpc BatchAnnotateImages(BatchAnnotateImagesRequest) returns (BatchAnnotateImagesResponse) {
    option (google.api.http) = { post: "/v1/userImages:annotate" body: "*" };
  }
}

// Users describe the type of Google Cloud Vision API tasks to perform over
// userImages by using *Feature*s. Each Feature indicates a type of image
...
// Set of crop hints that are used to generate new crops when serving userImages.
