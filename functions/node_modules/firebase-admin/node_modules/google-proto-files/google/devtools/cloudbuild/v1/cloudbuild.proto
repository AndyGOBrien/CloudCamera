...
message BuildStep {
  ...
  // userImages, like "ubuntu", "debian", but they will be refreshed at the time you
  // attempt to use them.
  //
...
message Results {
  ...
  repeated BuiltImage userImages = 2;
...
message Build {
  ...
  // A list of userImages to be pushed upon the successful completion of all build
  // steps.
  //
  // The userImages will be pushed using the builder service account's credentials.
  //
  // The digests of the pushed userImages will be stored in the Build resource's
  // results field.
  //
  // If any of the userImages fail to be pushed, the build is marked FAILURE.
  repeated string userImages = 13;
