...
// Copy all static userImages
gulp.task('userImages', ['clean'], function() {
  return gulp.src(paths.userImages)
...
gulp.task('watch', function() {
  ...
  gulp.watch(paths.userImages, ['userImages']);
});

// The default task (called when you run `gulp` from cli)
gulp.task('default', ['watch', 'scripts', 'userImages']);
```
